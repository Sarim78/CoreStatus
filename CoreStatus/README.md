# 🖥️ CoreStatus — System Resource Monitor Dashboard
...
>
> The frontend dashboard UI is complete, but the Python backend (`app.py`) is still being built out. Live data updates are **not functional yet** — the dashboard currently shows placeholder/static values only.
>
...
Once the Python backend is complete, setup will be:
